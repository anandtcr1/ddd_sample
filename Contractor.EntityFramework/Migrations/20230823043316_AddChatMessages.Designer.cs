...
namespace Contractor.Migrations
{
    ...
    [Migration("20230823043316_AddChatMessages")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Contractor.Chathub.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Contractor.Identities.ProfileAccessDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProfileAccessDefinition");
                });
            ...
            modelBuilder.Entity("Contractor.Chathub.ChatMessage", b =>
                {
                    b.HasOne("Contractor.Identities.User", "FromUser")
                        .WithMany()
                        .HasForeignKey("FromUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Contractor.Identities.User", "ToUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Contractor.Identities.ProfileAccessDefinition", b =>
                {
                    b.HasOne("Contractor.Files.AccessDefinition", "AccessDefinition")
                        .WithMany("ProfileAccessDefinitions")
                        .HasForeignKey("AccessDefinitionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Contractor.Identities.UserProfile", "User")
                        .WithMany("ProfileAccessDefinitions")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Contractor.Files.AccessDefinition", b =>
                {
                    ...
                    b.Navigation("ProfileAccessDefinitions");
